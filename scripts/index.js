...
world.afterEvents.playerInteractWithBlock.subscribe(function (event) {
	...
	if (!DOOR_LIST.includes(event.block.typeId)) return;
	...
	if (!DOOR_LIST.includes(neighbor.typeId)) return;
